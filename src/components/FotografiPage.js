...
import NavbarDesktopFoto from "./NavbarDesktopFoto";
...
const FotografiPage = ({
  ...
  useEffect(() => {
    ...
    gsap.to(panelsPink.current, {
      ...
      ease: "none",
      scrollTrigger: {
        trigger: pinkRef.current,
        scroller: containerRef.current,
        pin: true,
        scrub: true,
        // snap: 1 / (totalPanels - 1),
        // base vertical scrolling on how wide the container is so it feels more natural.
        end: () => "+=" + pinkRef.current.offsetWidth,
        onEnter: () => {
    ...
    return (
      ...
      >
        ...
        <div className="container" data-scroll-section>
          <NavbarDesktopFoto
            deltaY={deltaY}
            target={".fotografipage-container"}
            cursor={cursor}
            kuning={kuning}
            coklat={coklat}
          />
          ...
          <div className="pink-container" ref={pinkRef}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <img
                        ...
                        style={{
                          visibility: aLoaded[i] ? "hidden" : "visible",
                        }}
                      />
                      <LazyLoadImage
                        alt="A+"
                  ...
                  return (
                    <div className="foto" key={i}>
                      ...
                      <img
                        ...
                        className="placeholder"
                        style={{
                          visibility: uyuLoaded[i] ? "hidden" : "visible",
                        }}
                      />
                      <LazyLoadImage
                        alt="Uyu"
                  ...
                  return (
                    <div className="foto" key={i}>
                      ...
                      <img
                        ...
                        className="placeholder"
                        style={{
                          visibility: koceLoaded[i] ? "hidden" : "visible",
                        }}
                      />
                      <LazyLoadImage
                        alt="Koce"
                  ...
                  return (
                    <div className="foto" key={i}>
                      ...
                      <img
                        ...
                        className="placeholder"
                        style={{
                          visibility: kopiLoaded[i] ? "hidden" : "visible",
                        }}
                      />
                      <LazyLoadImage
                        alt="Kopi"
